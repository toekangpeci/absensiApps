...
public class home extends javax.swing.JFrame {
    ...
    public void panelling(){
            String sql = "select panelAppRep from jabatan where kode_jabatan='"+txtJabatan.getText()+"'";    
            ...
            if (akses.equals("111")){
            panApp.setVisible(true); 
            panRep.setVisible(true);
            panMan.setVisible(true);}
            else if (akses.equals("110")){
            panApp.setVisible(true); 
            panRep.setVisible(true);
            panMan.setVisible(false);}
            else if (akses.equals("101")){
            panApp.setVisible(true); 
            panRep.setVisible(false);
            panMan.setVisible(true);}
    ...
    public void cekDanUpdate(){
             long gaji=0;
             String b=cb_slipKaryawan.getSelectedItem().toString();
             String trimmed = b.replaceAll(" .*", "");
             int bulan= slipMonth.getMonth()+1;
             String bulans=null;
             if (bulan<10){bulans="0"+Integer.toString(bulan);}              
             int tahun  = slipYear.getYear();
             String x=bulans+"-"+Integer.toString(tahun);
    
        String sql="select * from gaji_logs where id_user='"+trimmed+"' and periode="+x+" order by periode desc limit 1";        
        try{
        ...
        if (para2==0){
        try {
                String esql="SELECT * FROM gaji_logs WHERE id_user='"+trimmed+"' order by date desc limit 1";
                 Statement est = conn.createStatement(); ResultSet ers = est.executeQuery(esql); 
                    while (ers.next()){gaji=ers.getLong("gaji");}
        
                 String dsql="insert into gaji_logs (id_user,gaji,periode) values (?,?,?)";
                 PreparedStatement dstat=conn.prepareStatement(dsql);  
                 dstat.setString(1,trimmed);        
                 dstat.setLong(2,gaji);
                 dstat.setString(3,x);
                 dstat.executeUpdate();
            }
            catch(Exception ex){JOptionPane.showMessageDialog(null,"data gagal dipanggil ketika if : "+ex);}}
             else {}   
     ...
     public void combo_karyawan(){
        ...
        try{     
            String path="./src/report/repSlipGaji_noPara.jasper";
            
            HashMap parameter = new HashMap();
            parameter.put("id_karyawan",trimmed);
            parameter.put("periode",x);
//            parameter.put("tahun",tahun);
            JasperPrint print = JasperFillManager.fillReport(path,parameter,conn);
            JasperViewer.viewReport(print,false);
        }
...
//             String month = monthFormatter.format(Month.values()[slipMonth.getMonth()]);
    ...
    private void initComponents() {
        ...
        panMan.setBackground(new java.awt.Color(32, 74, 86));
        ...
        javax.swing.GroupLayout panManLayout = new javax.swing.GroupLayout(panMan);
        panMan.setLayout(panManLayout);
        panManLayout.setHorizontalGroup(
            panManLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panManLayout.createSequentialGroup()
                .addGap(38, 38, 38)
                .addGroup(panManLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panApp.setBackground(new java.awt.Color(32, 74, 86));
        ...
        panAppLayout.setVerticalGroup(
            panAppLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panAppLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        panRep.setBackground(new java.awt.Color(32, 74, 86));
        ...
        javax.swing.GroupLayout panRepLayout = new javax.swing.GroupLayout(panRep);
        panRep.setLayout(panRepLayout);
        panRepLayout.setHorizontalGroup(
            panRepLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panRepLayout.createSequentialGroup()
                .addGap(38, 38, 38)
                .addComponent(menu_home2)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panRepLayout.setVerticalGroup(
            panRepLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panRepLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(menu_home2)
                .addContainerGap())
        );
        ...
        p_sidebarLayout.setHorizontalGroup(
            ...
            .addGroup(p_sidebarLayout.createSequentialGroup()
                .addGroup(p_sidebarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(panApp, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(panMan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(panRep, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        p_sidebarLayout.setVerticalGroup(
            ...
            .addGroup(p_sidebarLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panMan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panApp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panRep, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        p_homeLayout.setVerticalGroup(
            ...
            .addGroup(p_homeLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(p_perusahaan_main9, javax.swing.GroupLayout.PREFERRED_SIZE, 545, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(279, 279, 279))
        );
    ...
    private void repSlipMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_repSlipMouseClicked
        // TODO add your handling code here:           
             ...
             int bulan= slipMonth.getMonth()+1;
             int tahun  = slipYear.getYear();
             String sql="select id_transaksi,tanggal "
                     + "from logs_transaksi where id_user='"+trimmed+"' and month(tanggal)='"+bulan+"'"
    ...
    private javax.swing.JPanel panMan;
